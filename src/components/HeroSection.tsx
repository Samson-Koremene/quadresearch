    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="absolute z-30 top-3 left-2 lg:-left-10 bg-white/95 rounded-lg sm:rounded-xl px-2 sm:px-3 py-1.5 sm:py-2 shadow-lg flex items-center gap-1.5 sm:gap-2 animate-float"
        ...
        <motion.div
          ...
          className="absolute z-30 top-[35%] right-2 lg:-right-10 bg-white/95 rounded-lg sm:rounded-xl px-2 sm:px-3 py-1.5 sm:py-2 shadow-lg flex items-center gap-1.5 sm:gap-2 animate-float"
        ...
        <motion.div
          ...
          className="absolute z-30 bottom-5 left-2 lg:-left-10 bg-white/95 rounded-lg sm:rounded-xl px-2 sm:px-3 py-1.5 sm:py-2 shadow-lg flex items-center gap-1.5 sm:gap-2 animate-float"
          style={{ animationDelay: "2.4s", transform: "translateZ(30px)" }}
        >
...
const HeroSection = () => {
  ...
  return (
    <section
      ...
      style={{
        background: "linear-gradient(135deg, hsl(216,35%,10%) 0%, hsl(217,45%,14%) 60%, hsl(216,35%,11%) 100%)",
      }}
    >
      {/* Faint academic pattern */}
      ...
      <div
        className="pointer-events-none absolute -top-40 -left-20 w-[500px] h-[500px] rounded-full opacity-20"
        style={{ background: "radial-gradient(circle, hsl(217,89%,50%) 0%, transparent 70%)" }}
      />
      <div
        className="pointer-events-none absolute bottom-0 right-0 w-[350px] h-[350px] rounded-full opacity-10"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-end py-16 lg:min-h-[88vh] lg:py-20">
          ...
          {/* LEFT */}
          <div className="order-1 lg:order-1 z-10 text-center lg:text-left lg:self-center pb-10 lg:pb-20">
            <motion.h1
            ...
            >
              ...
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto h-14 px-8 text-base font-semibold rounded-2xl bg-transparent text-white/75 hover:text-white hover:bg-white/8 transition-colors"
          ...
          <motion.div
            ...
            className="relative order-2 lg:order-2 flex justify-center lg:justify-end items-end z-10 lg:self-end"
          >
            <Image3D />
          </motion.div>
        </div>
